 ...
 * @author Gustavo
 */
public class ListarEntradasProveedor extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        lista = transacciondao.ListarEntradasProveedor(codigo, provedor1);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            provedor1=proveedor;
            System.out.println("Mi porveedor es : "+provedor1);
