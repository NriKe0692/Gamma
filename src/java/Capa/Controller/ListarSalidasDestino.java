 ...
 * @author Gustavo
 */
public class ListarSalidasDestino extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        lista=transacciondao.ListarSalidasDestino(codigo, destino1);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String proveedor = jsonObj.getString("destino");
            destino1 = proveedor;
            System.out.println("Mi Destino  es : " + destino1);
